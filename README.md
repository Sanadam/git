...
git push -u origin branch # впервые пушим локальную ветку в удаленную репу, где такой ветки еще нет
git push --set-upstream origin new_branch # первый раз пушим новую ветку в удаленные репо, где её еще нет  
```
